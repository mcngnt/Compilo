.ORIG x3000
LD R6 CST27 ; Init R6 value to the start of the stack
BR IGNORE_CST27
CST27 .FILL #65023
IGNORE_CST27
ADD R5 R6 #0
LD R4 CST28 ; R4 <- address of label STATIC_VAR
BR IGNORE_CST28
CST28 .FILL #12615
IGNORE_CST28
ADD R4 R4 #1
LD R3 CST29 ; R3 <- address of label FUN_USER_main
BR IGNORE_CST29
CST29 .FILL #12569
IGNORE_CST29
JMP R3
...
ADD R0 R0 #0
BRnz IGNORE_JMP18
LD R3 CST30 ; R3 <- address of label CMP_ELSE18
BR IGNORE_CST30
CST30 .FILL #12422
IGNORE_CST30
JMP R3
...
LD R3 CST31 ; R3 <- address of label CMP_ENDELSE18
BR IGNORE_CST31
CST31 .FILL #12423
IGNORE_CST31
JMP R3
...
ADD R0 R0 #0
BRnp IGNORE_JMP20
LD R3 CST32 ; R3 <- address of label IF_ELSE20
BR IGNORE_CST32
CST32 .FILL #12440
IGNORE_CST32
JMP R3
IGNORE_JMP20
LD R0 CST19 ; R0 <- cst 1
BR IGNORE_CST19
CST19 .FILL #1
IGNORE_CST19
...
RET
LD R3 CST33 ; R3 <- address of label IF_ENDELSE20
BR IGNORE_CST33
CST33 .FILL #12440
IGNORE_CST33
JMP R3
...
STR R0 R6 #0 ; Adding arg on the stack to call f
ADD R6 R6 #-1
LD R3 CST34 ; R3 <- address of label FUN_USER_f
BR IGNORE_CST34
CST34 .FILL #12377
IGNORE_CST34
JSRR R3
...
STR R0 R6 #0 ; Adding arg on the stack to call f
ADD R6 R6 #-1
LD R3 CST35 ; R3 <- address of label FUN_USER_f
BR IGNORE_CST35
CST35 .FILL #12377
IGNORE_CST35
JSRR R3
...
STR R0 R6 #0 ; Adding arg on the stack to call f
ADD R6 R6 #-1
LD R3 CST36 ; R3 <- address of label FUN_USER_f
BR IGNORE_CST36
CST36 .FILL #12377
IGNORE_CST36
JSRR R3
