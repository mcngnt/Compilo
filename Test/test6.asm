.ORIG x3000
LD R6 CST15 ; Init R6 value to the start of the stack
BR IGNORE_CST15
CST15 .FILL #65023
IGNORE_CST15
ADD R5 R6 #0
LD R4 CST16 ; R4 <- address of label STATIC_VAR
BR IGNORE_CST16
CST16 .FILL #12511
IGNORE_CST16
ADD R4 R4 #1
LD R3 CST17 ; R3 <- address of label FUN_USER_main
BR IGNORE_CST17
CST17 .FILL #12483
IGNORE_CST17
JMP R3
...
ADD R0 R0 #0
BRz IGNORE_JMP6
LD R3 CST18 ; R3 <- address of label CMP_ELSE6
BR IGNORE_CST18
CST18 .FILL #12420
IGNORE_CST18
JMP R3
...
LD R3 CST19 ; R3 <- address of label CMP_ENDELSE6
BR IGNORE_CST19
CST19 .FILL #12421
IGNORE_CST19
JMP R3
...
ADD R0 R0 #0
BRnp IGNORE_JMP11
LD R3 CST20 ; R3 <- address of label IF_ELSE11
BR IGNORE_CST20
CST20 .FILL #12437
IGNORE_CST20
JMP R3
IGNORE_JMP11
LD R0 CST10 ; R0 <- cst 1
BR IGNORE_CST10
CST10 .FILL #1
IGNORE_CST10
...
RET
LD R3 CST21 ; R3 <- address of label IF_ENDELSE11
BR IGNORE_CST21
CST21 .FILL #12437
IGNORE_CST21
JMP R3
...
ADD R6 R6 #-1
STR R0 R6 #0
LD R3 CST22 ; R3 <- address of label FUN_USER_f
BR IGNORE_CST22
CST22 .FILL #12377
IGNORE_CST22
JSRR R3
...
ADD R6 R6 #-1
ADD R5 R6 #0 ; R5 <- R6
LD R0 CST12 ; R0 <- cst 2
BR IGNORE_CST12
CST12 .FILL #2
IGNORE_CST12
ADD R6 R6 #-1
STR R0 R6 #0
LD R3 CST23 ; R3 <- address of label FUN_USER_f
BR IGNORE_CST23
CST23 .FILL #12377
IGNORE_CST23
JSRR R3
